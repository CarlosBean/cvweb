...
export class CurriculumPDFService {
  ...
  certifications = [
    ...
    {
      name: "RESTful Service PHP y MySQL",
      id: "UC-5A16YJC5",
      company: "Udemy",
    },
  ];
      ...
      columns: [
        {
          stack: [
            ...
            {
              style: "subheader",
              text: this.translate.instant("main.contact"),
            },
            ...
            {
              style: ["bold", "mb_3"],
              text: "carlosbenavides.dev",
              link: this.personalWebURL,
            },
            ...
            {
              style: "subheader",
              text: this.translate.instant("main.languages"),
            },
            {
              style: ["ul", "mb_3"],
              ul: [
                `${this.translate.instant(
                  "main.spanish"
                )} - ${this.translate.instant("main.native")}`,
                `${this.translate.instant(
                  "main.english"
                )} - ${this.translate.instant("main.intermediate")}`,
              ],
            },
          ],
          width: "27%",
        },
        {
          stack: [
            ...
            {
              style: "subheader",
              text: this.translate.instant("main.summary"),
            },
            ...
            {
              style: "subheader",
              text: this.translate.instant("main.experience"),
            },
            ...
            {
              style: "subheader",
              text: this.translate.instant("main.education"),
            },
            {
              style: "lead",
              columns: [
            ...
            {
              style: "subheader",
              text: this.translate.instant("main.certifications"),
            },
  ...
  buildExperience(data: any[]): any[] {
    return data.map(({ company, jobPosition, start, end, desc }) => {
      ...
      let stack = [
        {
          style: "lead",
          columns: [jobPosition, { text: date, style: "right" }],
        },
  ...
  buildCertifications(data: any[]): any[] {
    return data.map(({ name, id, company }) => {
      return {
        bold: true,
        columns: [name, { text: `${company} | ${id}`, style: "right" }],
      };
    });
  }
  ...
  async createPDF() {
    this.buildContent();
    this.content.columns[0].stack[0].image = await this.getBase64ImageFromURL(
      this.avatarURL
    );
